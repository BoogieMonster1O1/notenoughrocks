...
public class Elements {
    ...
    public static class ItemS{
        public static BlockItem LIMESTONE_BLOCK_ITEM = new BlockItem(LIMESTONE_BLOCK,new Settings().group(NER).group(NER));
        ...
        public static BlockItem BLACKSTONE_COLUMN_ITEM = new BlockItem(BLACKSTONE_COLUMN,new Settings().group(NER));
        public static BlockItem BLACKSTONE_BRICK_COLUMN_ITEM = new BlockItem(BLACKSTONE_BRICK_COLUMN,new Settings().group(NER));
        public static BlockItem POLISHED_BLACKSTONE_COLUMN_ITEM = new BlockItem(POLISHED_BLACKSTONE_COLUMN,new Settings().group(NER));
    }
